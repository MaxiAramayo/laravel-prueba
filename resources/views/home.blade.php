...
@section('content')
    <div class="bg-gray-700 px-20 py-16 rounded-lg mb-8 relative overflow-hidden">
        ...
        <p class="text-sm text-gray-400 mt-2 z-1">Proyecto de desarrollo web para profesionales</p>
        <img src="{{ asset('images/dev.png') }}" class="absolute h-96 -right-14 -bottom-10 opacity-20 ">
    </div>
            ...
            <div class="grid grid-cols-1 gap-4 mb-4">
                @foreach ($posts as $post)
                    <a href="{{ route('post', $post->slug) }}" class="bg-gray-100 rounded-lg px-6 py-4">
                        ...
                        <div class="flex items-center justify-start text-gray-500 gap-1">
